...
public class AuthenticationError_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.wrapper.spotify.model_objects.credentials.error.AuthenticationError"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(AuthenticationError_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.wrapper.spotify.model_objects.credentials.error.AuthenticationError$JsonUtil",
      "com.wrapper.spotify.model_objects.IModelObject",
      "com.google.gson.JsonPrimitive",
      "com.wrapper.spotify.model_objects.IModelObject$Builder",
      "com.wrapper.spotify.model_objects.credentials.error.AuthenticationError",
      "com.wrapper.spotify.model_objects.specification.PagingCursorbased"
    );
  } 
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.gson.JsonArray", false, AuthenticationError_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.JsonElement", false, AuthenticationError_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.JsonObject", false, AuthenticationError_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(AuthenticationError_ESTest_scaffolding.class.getClassLoader()); 
