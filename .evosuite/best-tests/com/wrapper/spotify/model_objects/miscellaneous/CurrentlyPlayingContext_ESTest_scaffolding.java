...
public class CurrentlyPlayingContext_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.wrapper.spotify.model_objects.miscellaneous.CurrentlyPlayingContext"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(CurrentlyPlayingContext_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.wrapper.spotify.model_objects.miscellaneous.CurrentlyPlayingContext$JsonUtil",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(CurrentlyPlayingContext_ESTest_scaffolding.class.getClassLoader()); 
