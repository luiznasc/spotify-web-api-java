...
public class RecommendationsSeed_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.wrapper.spotify.model_objects.specification.RecommendationsSeed"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(RecommendationsSeed_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.gson.JsonElement", false, RecommendationsSeed_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.JsonObject", false, RecommendationsSeed_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(RecommendationsSeed_ESTest_scaffolding.class.getClassLoader()); 
