...
public class SavedTrack_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.wrapper.spotify.model_objects.specification.SavedTrack"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SavedTrack_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.wrapper.spotify.model_objects.specification.SavedTrack$Builder",
      ...
      "com.wrapper.spotify.model_objects.specification.SavedTrack$JsonUtil",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.gson.JsonElement", false, SavedTrack_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.JsonObject", false, SavedTrack_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SavedTrack_ESTest_scaffolding.class.getClassLoader()); 
