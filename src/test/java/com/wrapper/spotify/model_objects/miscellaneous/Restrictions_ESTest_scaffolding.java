...
public class Restrictions_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.wrapper.spotify.model_objects.miscellaneous.Restrictions"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(Restrictions_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.wrapper.spotify.model_objects.miscellaneous.Restrictions$JsonUtil",
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("com.google.gson.JsonElement", false, Restrictions_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("com.google.gson.JsonObject", false, Restrictions_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(Restrictions_ESTest_scaffolding.class.getClassLoader()); 
