...
public class SnapshotResult_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.wrapper.spotify.model_objects.special.SnapshotResult"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(SnapshotResult_ESTest_scaffolding.class.getClassLoader() ,
      ...
      "com.wrapper.spotify.model_objects.special.SnapshotResult$JsonUtil",
  ...
  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(SnapshotResult_ESTest_scaffolding.class.getClassLoader()); 
