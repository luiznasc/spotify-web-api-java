...
public class ToggleShuffleForUsersPlaybackRequest_ESTest_scaffolding {
  ...
  public static void initEvoSuiteFramework() { 
    org.evosuite.runtime.RuntimeSettings.className = "com.wrapper.spotify.requests.data.player.ToggleShuffleForUsersPlaybackRequest"; 
  ...
  private static void initializeClasses() {
    org.evosuite.runtime.classhandling.ClassStateSupport.initializeClasses(ToggleShuffleForUsersPlaybackRequest_ESTest_scaffolding.class.getClassLoader() ,
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    mock(Class.forName("org.apache.http.entity.ContentProducer", false, ToggleShuffleForUsersPlaybackRequest_ESTest_scaffolding.class.getClassLoader()));
  }

  private static void resetClasses() {
    org.evosuite.runtime.classhandling.ClassResetter.getInstance().setClassLoader(ToggleShuffleForUsersPlaybackRequest_ESTest_scaffolding.class.getClassLoader()); 
